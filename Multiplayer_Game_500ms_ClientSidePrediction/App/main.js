...
window.addEventListener('keydown', function(event) {
    sequenznummer++;    //Auskommentieren für Vorführung Zurücksetzen
    ...
    playerMoves[sequenznummer] = {x: players[index].x, y: players[index].y}; //Auskommentieren für Vorführung Zurücksetzen
